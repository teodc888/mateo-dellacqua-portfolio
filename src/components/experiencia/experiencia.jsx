        ...
        <Box component="div" className={classes.timeLineItem}>
          ...
          >
            <p>
              ...
              Page Application) sobre Paises
            </p>{" "}
            <p>
              .Para el Front-End se utilizó React y Redux como State Management{" "}
            </p>{" "}
            <p>
              . Todos los componentes tuvieron estilos con CSS puro, sin el uso
              de librerías externas o frameworks{" "}
            </p>{" "}
            <p>
              ...
              informacion necesaria en nuestra Base De Datos (PostgreSQL){" "}
            </p>{" "}
            <p>
              . Algunos features del proyecto: Cache de búsquedas, ordenamientos
              y filtros, formulario controlado para la creación de actividades,
              que luego se almacenan en una base de datos{" "}
            </p>{" "}
        ...
        <Box component="div" className={classes.timeLineItem}>
          ...
          >
            ...
            <p>
              ...
              como: React, Redux, Material UI, Sequelize, Express, Checkout Pro
              Mercado pago, auth0 Sengrid.Sengrid.{" "}
            </p>
          </Typography>
        </Box>
        <Typography
